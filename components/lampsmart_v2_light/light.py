...
lampsmartv2_ns = cg.esphome_ns.namespace('lampsmartv2')
LampSmartV2Light = lampsmartv2_ns.class_('LampSmartV2Light', cg.Component, light.LightOutput)
PairAction = lampsmartv2_ns.class_("PairAction", automation.Action)
UnpairAction = lampsmartv2_ns.class_("UnpairAction", automation.Action)
...
CONFIG_SCHEMA = cv.All(
    light.RGB_LIGHT_SCHEMA.extend(
        {
            cv.GenerateID(CONF_OUTPUT_ID): cv.declare_id(LampSmartV2Light),
...
@automation.register_action(
    "lampsmartv2.pair", PairAction, ACTION_ON_PAIR_SCHEMA
)
@automation.register_action(
    "lampsmartv2.unpair", UnpairAction, ACTION_ON_UNPAIR_SCHEMA
)
async def lampsmartv2_pair_to_code(config, action_id, template_arg, args):
