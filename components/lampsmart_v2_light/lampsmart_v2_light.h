...
class LampSmartV2Light : public light::LightOutput, public Component, public EntityBase
#ifdef USE_API
...
template<typename... Ts> class PairAction : public Action<Ts...> {
 public:
  ...
  void play(Ts... x) override {
    ((LampSmartV2Light *)this->state_->get_output())->on_pair();
  }
...
template<typename... Ts> class UnpairAction : public Action<Ts...> {
 public:
  ...
  void play(Ts... x) override {
    ((LampSmartV2Light *)this->state_->get_output())->on_unpair();
  }
